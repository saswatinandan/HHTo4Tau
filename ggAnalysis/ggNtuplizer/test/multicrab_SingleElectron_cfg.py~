...
config.General.workArea = 'SingleMuon'
...
config.Data.outLFNDirBase = '/store/user/snandan/Moriond17/SingleMuon/'
...
if __name__ == '__main__':
    ...
    config.General.requestName = "SingleMuon_Run2016B-03Feb2017_ver1-v1"
