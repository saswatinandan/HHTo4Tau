...
process.ggNtuplizer = cms.EDAnalyzer("ggNtuplizer",
    ...
    **dict(
    ...
    jecAK8PayloadNames = cms.vstring('Summer16_23Sep2016V4_MC_L2Relative_AK8PFchs.txt', 
...
process.ggNtuplizerGen = cms.EDAnalyzer("GenParticleInfo")
...
process.egmGsfElectronIDSequence = cms.Sequence(process.electronMVAValueMapProducer+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.egmGsfElectronIDs+process.electronRegressionValueMapProducer)
...
process.p = cms.Path(process.regressionApplication+process.ggMETFiltersSequence+process.calibratedPatElectrons+process.egmGsfElectronIDSequence+process.ggNtuplizer)
