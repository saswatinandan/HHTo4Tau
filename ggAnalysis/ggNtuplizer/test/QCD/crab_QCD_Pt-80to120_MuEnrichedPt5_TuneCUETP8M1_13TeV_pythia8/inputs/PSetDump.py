...
process.p = cms.Path(process.regressionApplication+process.ggMETFiltersSequence+process.calibratedPatElectrons+process.calibratedPatPhotons+process.egmGsfElectronIDSequence+process.egmPhotonIDSequence+process.ggNtuplizer)
