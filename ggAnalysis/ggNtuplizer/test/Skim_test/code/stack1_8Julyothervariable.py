...
title =['leading#mu p_{t} in GeV','Subleading#mu p_{t} in GeV','Leading#tau p_{t} in GeV','Subleading#tau p_{t} in GeV','Leading#mu \eta','Subleading#mu \eta','Leading#tau \eta','Subleading#tau \eta','M_{#mu#mu#tau#tau} in GeV','M_{#mu#mu#tau#tau} in GeV','M_{#mu#mu#tau#tau} in GeV','M_{#mu#mu#tau#tau} in GeV']
...
fileList =  [('data_', 'Data19_controlPlotMuon.root'),
            ('ZZTo4L', '%s/zzTo4L_controlPlotMuon.root' %dirName),
            ('WW', '%s/WW_controlPlotMuon.root' %dirName),
            ('t#bar{t}+jets', '%s/TT_controlPlotMuon.root' %dirName),
            ('WJets', '%s/WJets_controlPlotMuon.root' %dirName),                
            ('DY', '%s/DY_controlPlotMuon.root' %dirName),
            ('WZ', '%s/WZ_controlPlotMuon.root' %dirName),
            ('ZZ', '%s/ZZ_controlPlotMuon.root' %dirName),
            ('ZH', '%s/ZH_controlPlotMuon.root' %dirName),
            ('Single Top', '%s/ST_controlPlotMuon.root' %dirName)]
