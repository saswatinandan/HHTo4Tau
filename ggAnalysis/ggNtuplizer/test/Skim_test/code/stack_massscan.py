...
def xs_calculator(fileList = []):
   ...
   for i in range(len(variable)) :
       ...
       filesig = ['Radion250_ME_controlPlotME.root','Radion260_ME_controlPlotME.root','Radion270_ME_controlPlotME.root','Radion280_ME_controlPlotME.root','Radion300_ME_controlPlotME.root','Radion320_ME_controlPlotME.root','Radion340_ME_controlPlotME.root','Radion350_ME_controlPlotME.root','Radion400_ME_controlPlotME.root','Radion450_ME_controlPlotME.root','Radion500_ME_controlPlotME.root','Radion550_ME_controlPlotME.root','Radion600_ME_controlPlotME.root','Radion650_ME_controlPlotME.root','Radion700_ME_controlPlotME.root','Radion750_ME_controlPlotME.root','Radion800_ME_controlPlotME.root','Radion900_ME_controlPlotME.root'] 
...
fileList =  [('data_', 'DataME_controlPlotME.root'),
            ('ZZTo4L', '%s/zzTo4L_ME_controlPlotME.root' %dirName),
            ('WW', '%s/WW_ME_controlPlotME.root' %dirName),
            ('t#bar{t}+jets', '%s/TT_ME_controlPlotME.root' %dirName),
            ('WJets', '%s/WJets_controlPlotME.root' %dirName),                
            ('DY', '%s/DY_controlPlotME.root' %dirName),
            ('WZ', '%s/WZ_ME_controlPlotME.root' %dirName),
            ('ZZ', '%s/ZZ_ME_controlPlotME.root' %dirName),
            ('ZH', '%s/ZH_ME_controlPlotME.root' %dirName),
            ('Single Top', '%s/ST_controlPlotME.root' %dirName)]
