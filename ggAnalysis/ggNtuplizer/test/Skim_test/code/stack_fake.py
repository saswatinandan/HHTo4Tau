...
fileList = [('data_', '%s/DYFakein_Data_EE.root' %dirName),
            ('t#bar{t}+jets', '%s/DYFakein_TT_EE.root' %dirName),
            ('WJets', '%s/DYFakein_WJetsToLNu_EE.root' %dirName),       
            ('DY', '%s/DYFakein_DY_EE.root' %dirName),
            ('WW', '%s/DYFakein_WW_EE.root' %dirName),
            ('WZ', '%s/DYFakein_WZ_EE.root' %dirName),
            ('ZZ', '%s/DYFakein_ZZ_EE.root' %dirName),
            ('Single Top', '%s/DYFakein_ST_EE.root' %dirName),
            ('ZZTo4L', '%s/DYFakein_zzTo4L_EE.root' %dirName)]
