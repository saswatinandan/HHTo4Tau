...
fileList = [('data_', '%s/WjetsFakein_SingleMuon.root' %dirName),
            ('t#bar{t}+jets', '%s/WjetsFakein_TT_Wjets.root' %dirName),
            ('WJets', '%s/WjetsFakein_Wjets.root' %dirName),       
            ('DY', '%s/WjetsFakein_DYJetsToLL_Wjets.root' %dirName),
            ('WW', '%s/WjetsFakein_WW_Wjets.root' %dirName),
            ('WZ', '%s/WjetsFakein_WZ_Wjets.root' %dirName),
            ('ZZ', '%s/WjetsFakein_ZZ_Wjets.root' %dirName),
            ('Single Top', '%s/WjetsFakein_ST_Wjets.root' %dirName),
            ('ZZTo4L', '%s/WjetsFakein_zzTo4L_Wjets.root' %dirName)]
