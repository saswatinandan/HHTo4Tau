...
#      hbkg1.GetXaxis().SetTitle(l[var])
      ...
      hbkg1.GetXaxis().SetTitle('M_{#mu#tau} in GeV')
      hbkg1.Draw('e2')
      h3.Draw("Epsame")



      pdf += l[var]+'_Wjets.png'
      c.SaveAs('%s' %pdf)
      f.Write()
      f.Close()
...
fileList =  [('data_', '../SingleMuon_controlPlot.root'),
            ('ZZTo4L', '../zzTo4L_Wjets_controlPlot.root'),
            ('WW', '../WW_Wjets_controlPlot.root'),
            ('t#bar{t}+jets', '../TT_Wjets_controlPlot.root'),
            ('WJets', '..//Wjets_Wjets_controlPlot.root' ),                
            ('DY', '..//DY_Wjets_controlPlot.root'),
            ('WZ', '../WZ_Wjets_controlPlot.root' ),
            ('ZZ', '../ZZ_Wjets_controlPlot.root'),
            ('Single Top', '../ST_Wjets_controlPlot.root')]
