...
variable =['pt_distribution_of_Leading_#mu_with_opposite_sign_muon_with_totCharge==0','pt_distribution_of_SubLeading_#mu_with_opposite_sign_muon_with_totCharge==0',
           'pt_distribution_of_Leading_#tau_with_opposite_sign_muon_with_totCharge==0','pt_distribution_of_SubLeading_#tau_with_opposite_sign_muon_with_totCharge==0',
           'eta_distribution_of_Leading_#mu_with_opposite_sign_muon_with_totCharge==0','eta_distribution_of_SubLeading_#mu_with_opposite_sign_muon_with_totCharge==0',
           'eta_distribution_of_Leading_#tau_with_opposite_sign_muon_with_totCharge==0','eta_distribution_of_SubLeading_#tau_with_opposite_sign_muon_with_totCharge==0',
           'InvariantMass_of_4_particle_with_opposite_sign_muon_with_totCharge==0_be4_mass_cut']
title =['Leading#mu p_{t} in GeV','Subleading#mu p_{t} in GeV','Leading#tau p_{t} in GeV','Subleading#tau p_{t} in GeV','Leading#mu \eta','Subleading#mu \eta','Leading#tau \eta','Subleading#tau \eta','M_{#mu#mu#tau#tau} in GeV']
...
fileList =  [('data_', '/eos/uscms/store/user/snandan/Data19_controlPlot0.5.root'),
            ...
            ('WJets', '%s/WJets_controlPlot0.5.root' %dirName),                
            ('DY', '%s/DY_controlPlot0.5.root' %dirName),
