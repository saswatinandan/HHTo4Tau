...
int  main(int argc, char** argv) {
  ...
  TH1F* h_massNor = new TH1F("mass_sysNor","nor",6,300,900);
  ...
  for ( Int_t i = 0; i < nentries_wtn; i++) {
    ...
    fflush(stdout);
    float PUWeight = 1;
    bool PassTrigger =   (HLTEleMuX >> 14 & 1) || (HLTEleMuX >> 15 & 1);
