...
def xs_calculator(fileList = []):
   ...
   for i in range(len(variable)) :
       ...
       filesig = ['Radion250_controlPlot0.5.root','Radion260_controlPlot0.5.root','Radion270_controlPlot0.5.root','Radion280_controlPlot0.5.root','Radion300_controlPlot0.5.root','Radion320_controlPlot0.5.root','Radion340_controlPlot0.5.root','Radion350_controlPlot0.5.root','Radion400_controlPlot0.5.root','Radion450_controlPlot0.5.root','Radion500_controlPlot0.5.root','Radion550_controlPlot0.5.root','Radion600_controlPlot0.5.root','Radion650_controlPlot0.5.root','Radion700_controlPlot0.5.root','Radion750_controlPlot0.5.root','Radion800_controlPlot0.5.root','Radion900_controlPlot0.5.root'] 
...
######don't need to go further  below #########
   ...
   binlow = [6,6,6,6]
   binhigh = [9,8,7,6]
   binlabel = ['600-1000','600-900','600-800','600-700']
...
fileList =  [#('data_', '/eos/uscms/store/user/snandan/Data19_controlPlotsys.root'),
