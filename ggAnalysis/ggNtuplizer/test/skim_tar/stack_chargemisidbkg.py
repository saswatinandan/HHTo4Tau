...
variable = ["BB_LL_OS","BB_ML_OS","BB_MM_OS","BB_HL_OS","BB_HM_OS","BB_HH_OS",
            ...
            "BB_LL_SS","BB_ML_SS","BB_MM_SS","BB_HL_SS","BB_HM_SS","BB_HH_SS",
                  ...
                  "BE_HM_SS","EB_HM_SS","BE_HH_SS",'inclusive_SS','inclusive_OS']
...
defaultOrder = [('DY', r.TColor.GetColor(250,202,255)),         ##500,500,500;100,10,100;200,20,200;300,30,300;600,60,60;40,40,40;
                ...
                ('TT',r.TColor.GetColor(600,60,60)),
                ('WJets',r.TColor.GetColor(300,30,300)),
                ('WW',r.TColor.GetColor(200,20,200)),
                ('ST',r.TColor.GetColor(100,10,100)),
...
#      ifile = r.TFile('chargemisid.root')
      ...
      bkg_hist = ['DY1JetsToLL','DYJetsToLL','DY2JetsToLL','DY3JetsToLL','DY4JetsToLL','ST_tW_antitop_5f',
                  'ST_tW_top_5f','ST_t-channel_antitop_4f','ST_t-channel_top_4f']

#      hbkg = r.TH1F('Bkg_','',nbins,x_low,x_high)
      hdy  = r.TH1F('dy_bkg','',nbins,x_low,x_high)
      hst = r.TH1F('st_bkg','',nbins,x_low,x_high)
      for ibkg in range(len(bkg_hist)) :
         h = ifile.Get('%s/%s' %(variable[i],bkg_hist[ibkg]))
         if h : 
            if bkg_hist[ibkg].find('DY') !=-1 :
               hdy.Add(h,1)
            if bkg_hist[ibkg].find('ST') != -1 :
               hst.Add(h,1)
      ...
      histDict['DY'].Add(hdy,1)
      histDict['ST'].Add(hst,1)
      stackDict = buildStackDict(histDict)
      legendDict = buildLegendDict(histDict, (0.40, 0.44, 0.72, 0.84))
      ...
      stackDict['s'].SetTitle(';M_{ee};Events' )
