...
def xs_calculator(fileList = []):
   ...
   for i in range(len(variable)) :
      ...
      l = [variable[i] +'_in_tau1iso_tau2iso',variable[i] +'_in_tau1anti_iso_nofake_weight',variable[i] +'_in_tau2anti_iso_nofake_weight',
           variable[i] +'_in_tau1antiso_tau2antiiso_nofake_weight',variable[i] +'_in_tau1anti_iso',variable[i] +'_in_tau2anti_iso',
...
fileList =  [('data_', '/eos/uscms/store/user/snandan/Data19_controlPlot_25June.root'),
