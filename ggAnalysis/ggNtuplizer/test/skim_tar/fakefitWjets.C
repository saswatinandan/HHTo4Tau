...
void fakefit_pt() {  
  ...
  std::string file[9]= {"WjetsFakeinSingleMuon.root","WjetsFakein_Wjetstest.root","WjetsFakeinTT_Wjets.root","WjetsFakein_STtest.root","WjetsFakeinDYJetsToLL_Wjets.root","WjetsFakeinWW_Wjets.root", "WjetsFakeinWZ_Wjets.root","WjetsFakeinZZ_Wjets.root","WjetsFakeinzzTo4L_Wjets.root"};
