...
void fakefit_pt() {  
  ...
  std::string file[9]= {"WjetsFakeinSingleElectron.root","WjetsFakein_Wjets_EE.root","WjetsFakeinTT_Wjets_EE.root","WjetsFakein_ST_Wjets_EE.root","WjetsFakein_DY_Wjets_EE.root","WjetsFakeinWW_Wjets_EE.root", "WjetsFakeinWZ_Wjets_EE.root","WjetsFakeinZZ_Wjets_EE.root","WjetsFakeinzzTo4L_Wjets_EE.root"};
  ...
  //   TH1D* ffd0 = new TH1D("ffd0", "JetToTau Fake function in DYJets Central Eta Region", nx, xlow, xhigh);
   ...
   can1->Print("fakeWjets_EE.png");
   can1->Print("fakeWjets_EE.pdf");
}
