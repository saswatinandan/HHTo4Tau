...
fileList = [('data_', '%s/DYFakein_Data19.root' %dirName),
            ('t#bar{t}+jets', '%s/DYFakein_TT.root' %dirName),
            ('WJets', '%s/DYFakein_Wjets.root' %dirName),       
            ('DY', '%s/DYFakein_DY.root' %dirName),
            ('WW', '%s/DYFakein_WW.root' %dirName),
            ('WZ', '%s/DYFakein_WZ.root' %dirName),
            ('ZZ', '%s/DYFakein_ZZ.root' %dirName),
            ('Single Top', '%s/DYFakein_ST.root' %dirName),
            ('ZH', '%s/DYFakein_ZH.root' %dirName),
            ('ZZTo4L', '%s/DYFakein_zzTo4L.root' %dirName)]
