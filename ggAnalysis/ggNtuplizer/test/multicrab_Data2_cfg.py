...
config.Data.outLFNDirBase = '/store/user/snandan/Moriond17/Data2/'
...
if __name__ == '__main__':
    ...
    config.General.requestName = "DoubleMuon_Run2016B-03Feb2017_ver1-v1"
    config.Data.inputDataset = "/DoubleMuon/Run2016B-03Feb2017_ver1-v1/MINIAOD"
    submit(config)

    config.General.requestName = "DoubleMuon_Run2016B-23Sep2016-v1"
    config.Data.inputDataset = "/DoubleMuon/Run2016B-23Sep2016-v1/MINIAOD"
    submit(config)

    config.General.requestName = "DoubleMuon_Run2016B-23Sep2016-v3"
    config.Data.inputDataset = "/DoubleMuon/Run2016B-23Sep2016-v3/MINIAOD"
    submit(config)



    config.General.requestName = "DoubleMuon_Run2016C-23Sep2016-v1"
    config.Data.inputDataset = "/DoubleMuon/Run2016C-23Sep2016-v1/MINIAOD"
    submit(config)

#    config.General.requestName = "DoubleMuon_Run2016C-02Feb2017-v2"
 #   config.Data.inputDataset = "/DoubleMuon/Run2016C-02Feb2017-v2/MINIAOD"
  #  submit(config)

    config.General.requestName = "DoubleMuon_Run2016D-23Sep2016-v1"
    config.Data.inputDataset = "/DoubleMuon/Run2016D-23Sep2016-v1/MINIAOD"
    submit(config)


    config.General.requestName = "DoubleMuon_Run2016E-23Sep2016-v1"
    config.Data.inputDataset = "/DoubleMuon/Run2016E-23Sep2016-v1/MINIAOD"
    submit(config)


    config.General.requestName = "DoubleMuon_Run2016F-23Sep2016-v1"
    config.Data.inputDataset = "/DoubleMuon/Run2016F-23Sep2016-v1/MINIAOD"
    submit(config)


    config.General.requestName = "DoubleMuon_Run2016G-23Sep2016-v1"
