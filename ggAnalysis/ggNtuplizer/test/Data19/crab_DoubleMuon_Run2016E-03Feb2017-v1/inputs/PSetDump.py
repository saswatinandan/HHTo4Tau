...
process.egmGsfElectronIDSequence = cms.Sequence(process.electronMVAValueMapProducer+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.egmGsfElectronIDs+process.electronRegressionValueMapProducer)
