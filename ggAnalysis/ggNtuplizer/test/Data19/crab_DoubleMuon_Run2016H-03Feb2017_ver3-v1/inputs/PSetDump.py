...
process.regressionApplication = cms.Sequence(process.slimmedElectrons)
...
process.egmGsfElectronIDSequence = cms.Sequence(process.electronMVAValueMapProducer+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.egmGsfElectronIDs+process.electronRegressionValueMapProducer)
...
process.p = cms.Path(process.fullPatMetSequence+process.egcorrMET+process.ggMETFiltersSequence+process.regressionApplication+process.calibratedPatElectrons+process.egmGsfElectronIDSequence+process.ggNtuplizer)
