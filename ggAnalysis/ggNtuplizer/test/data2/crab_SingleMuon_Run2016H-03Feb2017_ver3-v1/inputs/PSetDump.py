...
process.cleanedCorPhotonsMuEGClean = cms.EDProducer("PATPhotonCleaner",
    checkOverlaps = cms.PSet(
        electrons = cms.PSet(
            algorithm = cms.string('bySuperClusterSeed'),
...
process.cleanedPhotonsMuEGClean = cms.EDProducer("PATPhotonCleaner",
    checkOverlaps = cms.PSet(
        electrons = cms.PSet(
            algorithm = cms.string('bySuperClusterSeed'),
            requireNoOverlaps = cms.bool(True),
            src = cms.InputTag("slimmedElectronsBeforeGSFix")
        )
    ),
    finalCut = cms.string(''),
    preselection = cms.string(''),
    src = cms.InputTag("slimmedPhotonsBeforeGSFix")
)


process.corMETElectronMuEGClean = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("matchedElectronsMuEGClean","col1"),
    srcShifted = cms.InputTag("matchedElectronsMuEGClean","col2")
)


process.corMETPhotonMuEGClean = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("matchedPhotonsMuEGClean","col1"),
    srcShifted = cms.InputTag("matchedPhotonsMuEGClean","col2")
)
...
process.matchedElectronsMuEGClean = cms.EDProducer("PFMatchedCandidateRefExtractor",
    col1 = cms.InputTag("slimmedElectronsBeforeGSFix"),
    col2 = cms.InputTag("slimmedElectrons"),
    extractPFCandidates = cms.bool(False),
    pfCandCollection = cms.InputTag("")
)


process.matchedPhotonsMuEGClean = cms.EDProducer("PFMatchedCandidateRefExtractor",
    col1 = cms.InputTag("cleanedPhotonsMuEGClean"),
    col2 = cms.InputTag("cleanedCorPhotonsMuEGClean"),
    extractPFCandidates = cms.bool(False),
    pfCandCollection = cms.InputTag("")
)
...
process.newV4pfBoostedDoubleSVAK8TagInfosUpdatedJECAK8 = cms.EDProducer("BoostedDoubleSVProducer",
    R0 = cms.double(0.8),
    beta = cms.double(1.0),
    maxSVDeltaRToJet = cms.double(0.7),
    svTagInfos = cms.InputTag("newV4pfInclusiveSecondaryVertexFinderAK8TagInfosUpdatedJECAK8"),
    trackPairV0Filter = cms.PSet(
        k0sMassWindow = cms.double(0.03)
    ),
    trackSelection = cms.PSet(
...
process.newV4pfBoostedDoubleSecondaryVertexAK8BJetTagsUpdatedJECAK8 = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateBoostedDoubleSecondaryVertexAK8Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("newV4pfBoostedDoubleSVAK8TagInfosUpdatedJECAK8"))
)


process.newV4pfImpactParameterAK8TagInfosUpdatedJECAK8 = cms.EDProducer("CandIPProducer",
    ...
    jets = cms.InputTag("updatedPatJetsUpdatedJECAK8"),
...
process.newV4pfInclusiveSecondaryVertexFinderAK8TagInfosUpdatedJECAK8 = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(0.8),
    minimumTrackWeight = cms.double(0.5),
    trackIPTagInfos = cms.InputTag("newV4pfImpactParameterAK8TagInfosUpdatedJECAK8"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.patElectrons = cms.EDProducer("PATElectronProducer",
    ...
    userData = cms.PSet(
        ...
        userClasses = cms.PSet(
            src = cms.VInputTag(cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-loose"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-medium"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-tight"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-veto"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronHLTPreselection-Summer16-V1"), 
                cms.InputTag("egmGsfElectronIDs","heepElectronID-HEEPV70"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp80"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp90"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-HZZ-V1-wpLoose"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-loose"), 
                cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-medium"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-tight"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-veto"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronHLTPreselection-Summer16-V1"), cms.InputTag("egmGsfElectronIDs","heepElectronID-HEEPV70"), 
                cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp80"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp90"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-HZZ-V1-wpLoose"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-loose"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-medium"), 
                cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-tight"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-veto"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronHLTPreselection-Summer16-V1"), cms.InputTag("egmGsfElectronIDs","heepElectronID-HEEPV70"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp80"), 
                cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp90"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-HZZ-V1-wpLoose"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-loose"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-medium"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-tight"), 
                cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-veto"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronHLTPreselection-Summer16-V1"), cms.InputTag("egmGsfElectronIDs","heepElectronID-HEEPV70"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp80"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp90"), 
                ...
                cms.InputTag("egmGsfElectronIDs","cutBasedElectronHLTPreselection-Summer16-V1"), cms.InputTag("egmGsfElectronIDs","heepElectronID-HEEPV70"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp80"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp90"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-HZZ-V1-wpLoose"), 
                cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-loose"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-medium"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-tight"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-veto"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronHLTPreselection-Summer16-V1"), 
                cms.InputTag("egmGsfElectronIDs","heepElectronID-HEEPV70"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp80"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp90"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-HZZ-V1-wpLoose"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-loose"), 
                cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-medium"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-tight"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-veto"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronHLTPreselection-Summer16-V1"), cms.InputTag("egmGsfElectronIDs","heepElectronID-HEEPV70"), 
                cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp80"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp90"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-HZZ-V1-wpLoose"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-loose"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-medium"), 
                cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-tight"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-veto"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronHLTPreselection-Summer16-V1"), cms.InputTag("egmGsfElectronIDs","heepElectronID-HEEPV70"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp80"), 
...
process.patJetCorrFactorsTransientCorrectedUpdatedJECAK8 = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring('L1FastJet', 
...
process.patPFMetRawMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMet"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT0pcT1MuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT0pcT1"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT0pcT1SmearTxyMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT0pcT1SmearTxy"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT0pcT1TxyMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
...
process.patPFMetT1ElectronEnDownMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ElectronEnDown"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT1ElectronEnUpMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ElectronEnUp"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT1JetEnDownMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
...
process.patPFMetT1JetEnUpMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
...
process.patPFMetT1JetResDownMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
...
process.patPFMetT1JetResUpMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1JetResUp"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)


process.patPFMetT1MuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT1MuonEnDownMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1MuonEnDown"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT1MuonEnUpMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1MuonEnUp"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT1PhotonEnDownMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PhotonEnDown"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT1PhotonEnUpMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PhotonEnUp"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT1SmearJetResDownMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearJetResDown"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT1SmearJetResUpMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearJetResUp"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)


process.patPFMetT1SmearMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1Smear"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT1SmearTxyMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearTxy"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT1TauEnDownMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
...
process.patPFMetT1TauEnUpMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
...
process.patPFMetT1TxyMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1Txy"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.patPFMetT1UnclusteredEnDownMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
...
process.patPFMetT1UnclusteredEnUpMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
...
process.patPFMetTxyMuEGClean = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetTxy"),
    srcCorrections = cms.VInputTag(cms.InputTag("corMETPhotonMuEGClean"), cms.InputTag("corMETElectronMuEGClean"))
)
...
process.slimmedMETsMuEGClean = cms.EDProducer("PATMETSlimmer",
...
process.updatedPatJetsTransientCorrectedUpdatedJECAK8 = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(True),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(True),
    addTagInfos = cms.bool(False),
    discriminatorSources = cms.VInputTag(cms.InputTag("newV4pfBoostedDoubleSecondaryVertexAK8BJetTagsUpdatedJECAK8")),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsTransientCorrectedUpdatedJECAK8")),
    jetSource = cms.InputTag("updatedPatJetsUpdatedJECAK8"),
    tagInfoSources = cms.VInputTag(cms.InputTag("newV4pfBoostedDoubleSVAK8TagInfosUpdatedJECAK8"), cms.InputTag("newV4pfImpactParameterAK8TagInfosUpdatedJECAK8"), cms.InputTag("newV4pfInclusiveSecondaryVertexFinderAK8TagInfosUpdatedJECAK8")),
    userData = cms.PSet(
        userCands = cms.PSet(
            src = cms.VInputTag("")
        ),
...
process.selectedUpdatedPatJetsUpdatedJECAK8 = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    src = cms.InputTag("updatedPatJetsTransientCorrectedUpdatedJECAK8")
)
...
process.ggNtuplizer = cms.EDAnalyzer("ggNtuplizer",
    ...
    **dict(
    ...
    jecAK8PayloadNames = cms.vstring('Summer16_23Sep2016BCDV4_DATA_L2Relative_AK8PFchs.txt', 
        'Summer16_23Sep2016BCDV4_DATA_L3Absolute_AK8PFchs.txt', 
        'Summer16_23Sep2016BCDV4_DATA_L2L3Residual_AK8PFchs.txt'),
    muonSrc = cms.InputTag("slimmedMuons"),
    newParticles = cms.vint32(4000011, 4000013, 1000006, 1000021, 1000022, 
        1000024, 1000025, 35),
    packedPFCands = cms.InputTag("packedPFCandidates"),
    patTriggerResults = cms.InputTag("TriggerResults","","PAT"),
    pfMETLabel = cms.InputTag("slimmedMETsMuEGClean","","ggKit"),
    phoChargedIsolation = cms.InputTag("photonIDValueMapProducer","phoChargedIsolation"),
...
process.patMetModuleSequence = cms.Sequence(process.pfMet+process.patJetCorrFactorsReapplyJEC+process.patJetsReapplyJEC+process.basicJetsForMet+process.jetSelectorForMet+process.cleanedPatJets+process.metrawCalo+process.patPFMet)
...
process.egcorrMET = cms.Sequence(process.cleanedPhotonsMuEGClean+process.cleanedCorPhotonsMuEGClean+process.matchedPhotonsMuEGClean+process.matchedElectronsMuEGClean+process.corMETPhotonMuEGClean+process.corMETElectronMuEGClean+process.patPFMetT1MuEGClean+process.patPFMetRawMuEGClean+process.patPFMetT1SmearMuEGClean+process.patPFMetT1TxyMuEGClean+process.patPFMetTxyMuEGClean+process.patPFMetT1JetEnUpMuEGClean+process.patPFMetT1JetResUpMuEGClean+process.patPFMetT1SmearJetResUpMuEGClean+process.patPFMetT1ElectronEnUpMuEGClean+process.patPFMetT1PhotonEnUpMuEGClean+process.patPFMetT1MuonEnUpMuEGClean+process.patPFMetT1TauEnUpMuEGClean+process.patPFMetT1UnclusteredEnUpMuEGClean+process.patPFMetT1JetEnDownMuEGClean+process.patPFMetT1JetResDownMuEGClean+process.patPFMetT1SmearJetResDownMuEGClean+process.patPFMetT1ElectronEnDownMuEGClean+process.patPFMetT1PhotonEnDownMuEGClean+process.patPFMetT1MuonEnDownMuEGClean+process.patPFMetT1TauEnDownMuEGClean+process.patPFMetT1UnclusteredEnDownMuEGClean+process.slimmedMETsMuEGClean)
...
process.ggMETFiltersSequence = cms.Sequence(process.BadPFMuonFilter+process.BadChargedCandidateFilter)
...
process.ggPhotonIso_CITK_PUPPI_Sequence = cms.Sequence(process.puppi+process.egmPhotonIsolationMiniAOD+process.egmPhotonIsolationMiniAODPUPPI)
...
process.egmGsfElectronIDSequence = cms.Sequence(process.electronMVAValueMapProducer+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.heepIDVarValueMaps+process.egmGsfElectronIDs+process.electronRegressionValueMapProducer)
...
process.ggPhotonIso_CITK_Sequence = cms.Sequence(process.egmPhotonIsolationMiniAOD)
...
process.p = cms.Path(process.fullPatMetSequence+process.egcorrMET+process.ggMETFiltersSequence+process.regressionApplication+process.calibratedPatElectrons+process.calibratedPatPhotons+process.egmGsfElectronIDSequence+process.egmPhotonIDSequence+process.ggNtuplizer)
