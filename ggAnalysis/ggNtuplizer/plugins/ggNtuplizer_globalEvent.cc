...
ULong64_t   HLTDoubleTau_;
ULong64_t   HLTPho_;
ULong64_t   HLTJet_;
ULong64_t   HLTEleMuXIsPrescaled_;
ULong64_t   HLTDoubleTauIsPrescaled_;
...
void ggNtuplizer::fillGlobalEvent(const edm::Event& e, const edm::EventSetup& es) {
  ...
  for (size_t i = 0; i < trgNames.size(); ++i) {
    ...
    else if (name.find("HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v")    != string::npos) bitEleMuX = 23;///unpre
    else if (name.find("HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v") != string::npos) bitEleMuX = 24;
    else if (name.find("HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_v")    != string::npos) bitEleMuX = 25;///unpre///HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v3
    ...
    else if (name.find("HLT_Ele17_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v")             != string::npos) bitEleMuX = 33;
    ...
    else if (name.find("HLT_Mu8_TrkIsoVVL_Ele17_CaloIdL_TrackIdL_IsoVL_v")    != string::npos) bitEleMuX = 41;
    else if (name.find("HLT_Mu17_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v")   != string::npos) bitEleMuX = 42;

    if(name.find("HLT_Ele17_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v") != string::npos) htrig->Fill(0.5);
    if(name.find("HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v")!= string::npos) htrig->Fill(1.5);
    if(name.find("HLT_Mu8_TrkIsoVVL_Ele17_CaloIdL_TrackIdL_IsoVL_v")!= string::npos) htrig->Fill(2.5);
    if(name.find("HLT_Mu17_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v")!= string::npos) htrig->Fill(3.5);

    // double Tau triggers
    int bitDoubleTau = -1;
    if (name.find("HLT_DoubleMediumIsoPFTau35_Trk1_eta2p1_Reg_v")    != string::npos) bitDoubleTau = 0;
    else if (name.find("HLT_DoubleMediumIsoPFTau35_Trk1_eta2p1_Reg_v")   != string::npos) bitDoubleTau = 1;
    ...
    //cout << "prescale = " << isPrescaled << endl;
    ...
    if (bitDoubleTau >= 0) {
      HLTDoubleTau_            |= (isFired << bitDoubleTau);
      HLTDoubleTauIsPrescaled_ |= (isPrescaled << bitDoubleTau);
    }
